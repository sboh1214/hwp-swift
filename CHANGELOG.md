...
- **줄글의 베이스라인이 한글보다 1~2pt 낮게 그려지던 것을 바로잡았습니다** (#178).
  ...
  이제 세로 배치에 글꼴·CoreText의 ascent가 들어오지 않습니다 — 줄 상자를 CoreText의
  줄 origin 델타로 타일하고 각 줄의 베이스라인을 자기 상자 상단 + 자기 앵커에 둡니다.
  ...
  **정확히** 일치하고, `noori` 본문 18줄은 한글 PDF와 0.09pt 안에서 맞습니다(수정 전
  ...
  한글 실물의 PrvImage를 오라클로 쓰는 정합성 측정(34개 픽스처)은 **18개 개선·14개
  불변·2개 악화**로 합계 MAE가 0.0520에서 0.0495로 내려갔습니다. 악화한 둘은 이 수정이
