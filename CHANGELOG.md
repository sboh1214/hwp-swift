...
- **표 셀·글상자 안 글자, 글자처럼 취급 표, 쪽 번호가 한컴오피스 한글보다 위에 그려지던
  ...
  꼬리말(머리말) 여백이 0이면 아래(위) 여백의 가운데입니다. 이제 `noori` 1쪽의 제목 표·
  표 셀·문서 하단 표·쪽 번호가 한글 PDF의 베이스라인과 0.1pt 안에서 같고(종전 −5.35·
  −1.29~−2.58·−3.14·−31.67pt), 헌법주석 1,027쪽의 쪽 번호가 한컴 글꼴 모드에서 0.01pt
