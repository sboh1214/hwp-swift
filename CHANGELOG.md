...
- **위/아래 첨자에 건 취소선·'글자 가운데' 밑줄이 옮겨진 글자를 따라가지 않고 원래
  ...
  베이스라인** 위 0.35 × 축소 크기에 그리고(10pt 위 첨자: 4.44pt 위 + 2.28pt), '글자
  ...
  (종전에는 축소된 6.7pt 기준이라 첨자 밑줄이 0.56pt 위·두께 0.27pt였습니다). 서식 복사
  ...
  한글보다 10pt에서 약 0.9pt(위)·1.7pt(아래) 낮게 남으며 별도 이슈로 다룹니다.
