...
- **위/아래 첨자에 건 취소선·'글자 가운데' 밑줄이 옮겨진 글자를 따라가지 않고 원래
  ...
  동일성을 픽셀로 잠갔습니다. 첨자 글리프 자체의 올림·내림·축소 배율(우리 0.33em·
  0.30em·0.67배 vs 한글 0.446em·0.12em·0.64배)은 이 수정의 범위 밖이라 첨자 취소선이
  한글보다 10pt에서 약 0.9pt(위)·1.7pt(아래) 낮게 남으며 #204로 다룹니다.
