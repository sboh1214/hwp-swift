...
- **HWPX 문서의 각주·미주를 그립니다** (#168). `hp:footNote`·`hp:endNote`가
  ...
  "1 / 3" 머리말이 "1 / 1"이 됩니다. 남은 구역 부속 컨트롤(새 번호·쪽 감추기
  컨트롤·책갈피·찾아보기 표식 #169)은 아직 강등되며 `parseDiagnostics()`에
  보고됩니다.
- **HWPX 문서의 머리말·꼬리말을 그립니다** (#167). `hp:header`·`hp:footer`가
  ...
  컨트롤(새 번호·쪽 감추기 컨트롤·책갈피·찾아보기 표식 #169)은 아직 강등되며
  `parseDiagnostics()`에 보고됩니다.
