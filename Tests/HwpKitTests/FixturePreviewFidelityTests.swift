...
final class FixturePreviewFidelityTests: XCTestCase {
    ...
    private static let maeThresholds: [String: Double] = [
        ...
        // 2중선)은 우리가 아직 실선으로만 그려(#191) 그리드에는 거의 안 잡힌다.
        "line-shapes": 0.008, // 실측 0.0067 (2026-09-12)
        // 첨자 run의 장식선(#179) — 12×16 그리드는 선 1~2pt 이동에 둔감해 수정 전후가
        // 같은 0.0005다. 이 픽스처의 가드는 `FixtureDecorationLineRenderTests+Script`의
        // 픽셀 핀이고, 여기 값은 유실 가드다.
