  ...
  - **줄 상자·베이스라인·전진량도 같은 글꼴 줄 상자다** (#194, 2026-09-20 한글 12.30 실측:
    ...
    - **줄 끝 글자와 개체는 글자 상자에 쌓인다** (#223, 한글 12.30 실측 2026-09-25: 합성 HWPX 7종
      ...
      **상자 높이**다 — 크기도 베이스라인도 아니다: Menlo 10pt 글(1515)에 함초롬 10pt CR(1692)은
      ...
      20pt 한글 + Menlo 20pt 라틴 + 함초롬 30pt CR = 5076 + 910, Apple SD 혼자의 959가 아니다; 한글
      빈칸이 라틴 슬롯이라 Apple SD/Menlo 글자 모양의 한글 줄 T는 보통 1559/1104다). 비율 여분은
      종전대로 max(T, C) 기준(3132 줄의 160% `spacing` 1624 = 0.6 × 2706, 200% 2704)이고 고정·
      여백만·최소는 쌓인 상자에 걸린다(여백만 5 → 3632, 최소 30 → 3132). 한 줄 끝도 같다 — 10pt
      글 + 20pt 한 줄 끝 줄 `textheight` 3809, MS 워드 호환 문서의 한 줄 끝은 **라틴 슬롯** 글꼴이다
