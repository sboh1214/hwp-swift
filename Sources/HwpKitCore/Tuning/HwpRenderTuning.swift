...
public enum HwpRenderTuning {
    ...
    public enum LineShape {
        ...
        /// 한글 2007 호환 문서의 물결도 같다 (#227 실측: 2.88pt 진폭의 반주기 3.0pt,
        /// 1.44pt 진폭의 반주기 1.56pt).
        ...
        /// 4.80/1.44pt (한글 문서 40pt의 긴 점선은 11.40/6.84pt). 고정 두께 0.36pt의 4/3배다.
        ...
        /// 밑줄 종류(글자 아래 1·취소선과 글자 가운데 2·글자 위 3)만큼 위 — 한글 문서의 계단(단선
        /// 위 가장자리 + 두께 × 종류)과 같은 꼴에 기점·계단 폭만 고정이다. 실측(모델 참값 단선 중심
